...
export const DocumentUploader: React.FC<DocumentUploaderProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Persist metadata about the upload to our server for admin listing
      try {
        const payload = {
          userId: user?.id,
          userName: enhancedMetadata.userName,
          userEmail: enhancedMetadata.userEmail,
          uploadTimestamp: enhancedMetadata.uploadTimestamp,
        ...
        console.warn('Failed to persist upload metadata', err);
      }
