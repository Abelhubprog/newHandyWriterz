						...
						<tbody className="bg-white divide-y divide-gray-200">
							{services.map((service) => (
								<tr key={service.id}>
									...
									<td className="px-6 py-4">
										<div className="text-sm text-gray-900">{service._count?.categories} Categories</div>
										<div className="text-sm text-gray-500">{service._count?.content} Content Items</div>
									</td>
									<td className="px-6 py-4">
										<span
